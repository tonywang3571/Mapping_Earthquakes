...
// Create the earthquake laer for our map.
...
// Create the map object with center and zoom level. (same thing as below with added default layer)
...
// Create a legend contorl object
...
legend.onAdd = function() {
  ...
  // Loop  through intervals to generate a colored square label for each interval.
...
// Replaced above due to adding 'overlay' layer.
...
// This function returns style data for each earthquake we plot.
...
// This function determines the color of the cirle based on magitude.
function getColor(magitude) {
  if (magitude > 5) {
    return "#ea2c2c";
  }
  if (magitude > 4) {
